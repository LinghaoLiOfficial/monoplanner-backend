...
class ApiContractDraft(Base):
    __tablename__ = "api_contract_drafts"
    ...
    base_path: Mapped[str] = mapped_column(String(100), nullable=False, default="/api/v1")
    ...
    project: Mapped[Project] = relationship(back_populates="api_contract_drafts")
    ...
    context_packs: Mapped[list[ContextPack]] = relationship(back_populates="api_contract")
