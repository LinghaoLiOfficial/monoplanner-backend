...
class ContextPack(Base):
    ...
    api_contract_id: Mapped[UUID | None] = mapped_column(
        Uuid(as_uuid=True),
        ForeignKey("api_contract_drafts.id", ondelete="SET NULL"),
        nullable=True,
        index=True,
    )
    db_model_id: Mapped[UUID | None] = mapped_column(
        Uuid(as_uuid=True),
        ForeignKey("db_model_drafts.id", ondelete="SET NULL"),
        nullable=True,
        index=True,
    )
